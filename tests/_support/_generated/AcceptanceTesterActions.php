<?php  //[STAMP] aef090ba050ce10b82763cd1e1823021
...
trait AcceptanceTesterActions
{
     ...
     * @param $pan
     * @return string
     * @see \Helper\Acceptance::maskPan()
     */
    public function maskPan($pan) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('maskPan', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Acceptance::generateDate()
     */
    public function generateDate() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('generateDate', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Acceptance::getOTPByNumber()
     */
    public function getOTPByNumber($phonenum) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getOTPByNumber', func_get_args()));
    }
